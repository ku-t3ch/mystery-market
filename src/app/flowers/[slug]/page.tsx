...
const Title: Record<TitleKeys, TitleInfo> = {
  ...
  lavender: {
    ...
    description:
      "ถึงเธอที่รัก เธอช่างเหมือนดั่งดอกกล้วยไม้ ในยามเย็น คุณมักจะชอบใส่ใจรายละเอียดและความรับผิดชอบต่องาน ความพิถีพิถันปราณีตและการควบคุมอารมณ์คือเสน่ห์ของคุณ",
  },
  rose: {
    name: "rose",
    title: "Rose",
