...
export default function SunflowerPage() {
  const [pageTitle, setPageTitle] = useState("Sunflower");
  const [message, setMessage] = useState(
    `ถึงเธอที่รัก เธอช่างเหมือนดั่งดอกทานตะวัน 
    ในยามเช้าตรู่ คุณมักจะเป็นความสดใสและ
    เข้ากับผู้อื่นได้ง่ายความตื่นเต้นสนุกสนานและ
    การมองโลกในแง่ดี อันไร้ขีดจำกัดคือเสน่ห์ของคุณ`
  );
  return (
    <div
      style={{
      ...
      <div className="flex h-screen w-screen  backdrop-blur-sm flex-col ">
        <div className="flex justify-center flex-col w-full">
          <div className="flex  h-[114px] left-[258px] top-[387px]   mb-4  justify-center p-5 gap-5">
            ...
            <div className="flex flex-col w-[130px] h-[54px] left-[18px] top-[399px]  text-center text-zinc-800 text-5xl font-normal  leading-[96px] mr-20  mt-3">
