...
import Background from "@/../../public/assets/background/resulte_rainbow.jpg";
...
export default function LilyPage() {
  const [pageTitle, setPageTitle] = useState("lily");
  const [message, setMessage] = useState(
    `ถึงเธอที่รักเธอช่างเหมือนดั่งลิลลี่ในยาม
    บ่ายคุณมักช่างสงสัยใคร่รู้เและเปิดกว้างกับ
    เรื่องใหม่ๆตลอดการเผชิญความท้าทาย
    ใหม่ๆแลมีความคิดสร้างสรรค์อันยอด
    เยี่ยมคือเสน่ห์ของคุณ`
  );
  return (
  <>
      <div
        ...
        <div className="flex  w-screen   flex-col ">
          ...
          <div className="flex justify-center flex-col w-full">
            <div className="flex  h-[114px] left-[258px] top-[387px]   mb-4  justify-center p-5 gap-5">
              <div className="flex flex-col w-[130px] h-[54px] left-[18px] top-[399px]  text-center text-[#352f36]  font-bold  leading-[96px] mr-20  text-6xl ">
