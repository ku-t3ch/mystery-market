    ...
    return (
        <>
            ...
            <div className="flex flex-col items-center justify-center h-full w-full">
                <div className="relative w-[95vw] h-[400px] m-[-4rem]">
                    <Image priority src="/mystery-market/assets/images/butterflyeffect.png" fill className="object-contain" alt="Mystery Market Logo" />
                </div>
