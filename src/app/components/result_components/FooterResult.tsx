...
export default function FooterResult() {
  return (
    <>
      <div className=" ">
        <div className="flex flex-row justify-center w-full gap-4 m-2 mt-10">
          <Link
        ...
        <a
          className="text-black flex flex-row justify-center items-center gap-1"
        ...
        >
          ...
          tech.nisit.ku.ac.th/mystery-market
        </a>
      </div>
