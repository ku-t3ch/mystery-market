...
export const story: IStory[] = [
  ...
  },
  {
    ...
    title: "Bad Ending",
    story:
      "ถึงเธอที่รัก ช่างน่าเสียดายจริงๆ<br/>การเดินทางของคุณต้องจบลง<br/>โดยที่ไม่ได้รู้ความลับอะไรเลย<br/>ไม่เป็นไรนะ ยังมีเส้นทางอื่นๆมากมายรอคุณอยู่<br/>ถ้าเธออยากรู้ผลลัพธ์อื่นๆละก็... ลองเล่นอีกครั้งดูสิ!",
    go: 0, // reset to start
  },
  {
    scene_id: 10,
  ...
  {
    scene_id: 205,
    story: "ระหว่างทางคุณพบเด็กน้อย<br/>ในมือของเขาถือกระดาษรูปภาพดอกไม้อยู่",
    background: "/mystery-market/assets/background/boatvod1_047.webp",
    go: 209,
  },
  {
  ...
  {
    scene_id: 209.1,
    story: "คุณเข้าไปกอดเด็กน้อยคนนี้ <br/>เด็กน้อยค่อยๆสงบลง",
    background: "/mystery-market/assets/background/boatvod1_047.webp",
    go: 210,
  },
  {
